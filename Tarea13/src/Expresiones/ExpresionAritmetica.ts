export class ExpresionAritmetica{
    ...
    public valor : string;
    public izquierda : ExpresionAritmetica | null;
    public derecha : ExpresionAritmetica | null;
    public temp : number = 1;

    constructor(valor : string , izq : ExpresionAritmetica | null, der : ExpresionAritmetica | null ){
        this.valor = valor;
        this.izquierda = izq;
        this.derecha = der;
     }
